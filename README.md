...
| **ForeverTools.STT** | Speech-to-Text using Whisper (transcription, subtitles) | [![NuGet](https://img.shields.io/nuget/v/ForeverTools.STT.svg)](https://www.nuget.org/packages/ForeverTools.STT) |
