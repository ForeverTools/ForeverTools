...
|---------|-------------|-------|
| [ForeverTools.AIML](https://github.com/ForeverTools/ForeverTools.AIML) | Access 400+ AI models (GPT-4, Claude, Llama, Gemini, DALL-E, Stable Diffusion) | [![NuGet](https://img.shields.io/nuget/v/ForeverTools.AIML.svg)](https://www.nuget.org/packages/ForeverTools.AIML) |
